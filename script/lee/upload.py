...
class Uploader:
    def __init__(self, domain, appKey):
        self.device_api = "http://%s.51lvye.cn/upload/devices" % domain
        self.account_api = "http://%s.51lvye.cn/upload/accounts" % domain
        self.appKey = appKey
...
def main():
    ...
    if args.group == None:
        ...
        return 1
    appKey = "bab773267d0c0d5b875d040b6cf8c875"
    uploader = Uploader("ato", appKey)
